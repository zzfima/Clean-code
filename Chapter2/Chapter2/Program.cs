...
internal class Program
{
    ...
    public class Cell
    {
        ...
        public Cell(int status, int value)
        {
            _status = status;
            _value = value;
        }

        internal bool IsStatus(int status) => _status == status;
    }
}